...
1.11 **"Competitive Fork"** means any of the following:
    ...
    (b) An Interface-Conforming Implementation (as defined in Article 1.12) that exhibits any of the following characteristics —
        ...
        (iii) Its primary recruitment target is the original project's CLA Signatories or Contributors, with the intent of undermining the original project's community governance participation basis.
    ...
    **"Embedded"** means including the source code or executable code of the Licensed Work in a competitive offering as part of its distribution. The following circumstances all constitute embedding:
    (i) Distributing the Licensed Work as an internal component or dependency of the competitive offering;
    (ii) The competitive offering requires access to or download of the Licensed Work to operate;
    (iii) Using the Licensed Work, in whole or in part, through linking, bundling, or integration within the competitive offering.
