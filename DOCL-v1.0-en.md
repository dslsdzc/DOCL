...
1.11 **"Competitive Fork"** means any of the following:
    ...
    (b) An Interface-Conforming Implementation (as defined in Article 1.12) that exhibits any of the following characteristics —
        ...
        (ii) It systematically migrates the original project's community infrastructure, including but not limited to issue tracking, discussion forums, documentation, or CI/CD configuration. If the Licensor has given written notice and the migration has not ceased within fourteen (14) days, such migration shall be deemed systematic;
...
Upon request by the Licensor, you must provide access URLs to the Corresponding Source for each independent deployment environment (rather than each running instance) within thirty (30) days.
