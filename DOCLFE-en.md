...
10.3a **Version Reference and Retroactivity**: This License may be referenced by a specific version number (e.g., v1.0) or by "latest." If you reference "latest," you accept updates to subsequent versions of this License; however, updates shall **not be retroactive**. Copies already distributed or activities already conducted under the prior version shall continue to be governed by such prior version. New versions apply only to software versions first released or distributed after such update. If you believe an update materially increases your obligations, you may, within sixty (60) days of becoming aware of such update, notify the Licensor that you reject the update and continue under the prior version.
