...
10.3a **Version Reference and Upstream Tracking**:
    ...
    (c) **Upstream Upgrade Right**: The Licensor of the original project may upgrade the license version applied to their project. Such upgrade must be clearly indicated by publishing a new version number (e.g., v1.1, v2.0) and announced through official channels. Upon such upgrade, all forks based on that project **must follow** the upgrade. Fork maintainers may not fix or select a version on their own; failure to follow shall render the fork a Competitive Fork.
